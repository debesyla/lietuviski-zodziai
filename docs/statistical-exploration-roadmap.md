...
This is the implementation decision record for [issue #31](https://github.com/debesyla/lietuviski-zodziai/issues/31). It starts from what the reviewed public collections can actually measure, rather than choosing charts first and inventing meaning for the available fields.
...
1. Build and review the [DML6 coverage profile](https://github.com/debesyla/lietuviski-zodziai/issues/48) first: it has the clearest semantics and smallest additional delivery footprint.
2. Add the [bounded wartime contrast explorer](https://github.com/debesyla/lietuviski-zodziai/issues/47) next, using only observed normalized rates and explicit comparison pair controls.
